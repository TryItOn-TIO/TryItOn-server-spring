...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers("/api/products/**", "/api/home/products/**", "/api/stories/**").permitAll() // 모든 상품 관련 API 허용, 스토리 조회 허용 (비로그인 접근 가능)
            .requestMatchers("/api/wishlist/**", "/api/payment/**", "/api/orders/**", "/api/closet/**", "/api/avatar/**").authenticated() // 인증 필요
